...
- **tqk2_sjj** (2.75 bpv) degrades significantly on this short evaluation — it may perform better on longer contexts where KV cache memory savings matter more, but quality loss is substantial.
