...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQK_6HI_3LO_HAD_D256] = {
        .type_name                = "tqk4_sj_d256",
        .blck_size                = TQK_BLOCK_SIZE_D256,
        .type_size                = sizeof(block_tqk_6hi_3lo_d256),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tqk_6hi_3lo_had_d256,
    ...
    [GGML_TYPE_TQK_2HI_1LO_HAD_D256] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tqk_2hi_1lo_had_d256,
    ...
    [GGML_TYPE_TQK_3HI_2LO_HAD_D256] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tqk_3hi_2lo_had_d256,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tqk_3hi_2lo_had_d256_ref,
    },
    ...
    [GGML_TYPE_TQK_5R3_SJ] = {
        .type_name                = "tqk5r3_sj",
        .blck_size                = TQK_BLOCK_SIZE,
        .type_size                = sizeof(block_tqk_5r3_sj),
        .is_quantized             = true,
