...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO3_0_PROD] = {
        ...
        .type_size                = sizeof(block_tqk_25),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tqk_25,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tqk_25_ref,
    },
    [GGML_TYPE_TURBO4_0_PROD] = {
        .type_name                = "tqk35",
        .blck_size                = TQK_BLOCK_SIZE,
        .type_size                = sizeof(block_tqk_35),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tqk_35,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tqk_35_ref,
    },
    [GGML_TYPE_TURBO3_0_MSE] = {
        .type_name                = "tqv25",
        .blck_size                = TQV_BLOCK_SIZE,
        .type_size                = sizeof(block_tqv_25),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tqv_25,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tqv_25_ref,
    },
    [GGML_TYPE_TURBO4_0_MSE] = {
        .type_name                = "tqv35",
        .blck_size                = TQV_BLOCK_SIZE,
        .type_size                = sizeof(block_tqv_35),
        .is_quantized             = true,
