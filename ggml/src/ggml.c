...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO3_0_PROD] = {
        .type_name                = "tqk_lo",
        .blck_size                = QK_TURBO3_PROD,
        .type_size                = sizeof(block_turbo3_0_prod),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo3_0_prod,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo3_0_prod_ref,
    },
    [GGML_TYPE_TURBO4_0_PROD] = {
        .type_name                = "tqk_hi",
        .blck_size                = QK_TURBO4_PROD,
        .type_size                = sizeof(block_turbo4_0_prod),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_0_prod,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_0_prod_ref,
    },
    [GGML_TYPE_TURBO3_0_MSE] = {
        .type_name                = "tqv_lo",
        .blck_size                = QK_TURBO3_MSE,
        .type_size                = sizeof(block_turbo3_0_mse),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo3_0_mse,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo3_0_mse_ref,
    },
    [GGML_TYPE_TURBO4_0_MSE] = {
        .type_name                = "tqv_hi",
        .blck_size                = QK_TURBO4_MSE,
        .type_size                = sizeof(block_turbo4_0_mse),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_0_mse,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_0_mse_ref,
    },
};
