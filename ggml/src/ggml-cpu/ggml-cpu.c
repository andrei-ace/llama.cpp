...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQV_HAD_MSE4] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqv_had_mse4_ref,
        .nrows                    = 1,
    },
    ...
    [GGML_TYPE_TQV_HAD_MSE4_D256] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqv_had_mse4_d256_ref,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_6HI_3LO_HAD_D256] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_6hi_3lo_had_d256_ref,
        .vec_dot                  = ggml_vec_dot_tqk_6hi_3lo_had_d256_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_2HI_1LO_HAD_D256] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_2hi_1lo_had_d256_ref,
        .vec_dot                  = ggml_vec_dot_tqk_2hi_1lo_had_d256_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_3HI_2LO_HAD_D256] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_3hi_2lo_had_d256_ref,
        .vec_dot                  = ggml_vec_dot_tqk_3hi_2lo_had_d256_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_6HI_3LO_HAD] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_6hi_3lo_had_ref,
        .vec_dot                  = ggml_vec_dot_tqk_6hi_3lo_had_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_2HI_1LO_HAD] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_2hi_1lo_had_ref,
        .vec_dot                  = ggml_vec_dot_tqk_2hi_1lo_had_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    ...
    [GGML_TYPE_TQK_6HI_3LO_HAD_JJ] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_6hi_3lo_had_jj_ref,
        .vec_dot                  = ggml_vec_dot_tqk_6hi_3lo_had_jj_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_6HI_3LO_HAD_JJ_D256] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_6hi_3lo_had_jj_d256_ref,
        .vec_dot                  = ggml_vec_dot_tqk_6hi_3lo_had_jj_d256_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_5R3_SJ] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_5r3_sj_ref,
        .vec_dot                  = ggml_vec_dot_tqk_5r3_sj_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQK_FLEX] = {
        .from_float               = (ggml_from_float_t) quantize_row_tqk_flex_ref,
        .vec_dot                  = ggml_vec_dot_tqk_flex_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
};
