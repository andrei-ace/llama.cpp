...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TQK_2HI_1LO_HAD     = 61, // tqk2_sjj:      2.75 bpv, 32/96 split, 2-bit+QJL hi / 1-bit+QJL lo
        GGML_TYPE_TQK_3HI_2LO_HAD     = 62, // tqk3_sjj:     3.75 bpv, 32/96 split, 3-bit+QJL hi / 2-bit+QJL lo
        GGML_TYPE_TQK_6HI_3LO_HAD_D256 = 63, // tqk4_sj_d256:  3.94 bpv, d=256, 64/192 split, 5-bit+QJL hi / 3-bit lo
        GGML_TYPE_TQK_2HI_1LO_HAD_D256 = 64, // tqk2_sjj_d256:  2.50 bpv, d=256, 64/192 split, 2-bit+QJL hi / 1-bit+QJL lo
        ...
        GGML_TYPE_TQK_5R3_SJ = 69, // tqk5r3_sj: 4.625 bpv, 32/96 split, 5-bit+3-bit residual hi, 3-bit lo
        GGML_TYPE_TQK_FLEX   = 70, // tqk_flex:  runtime-configurable TQ type for testing
        GGML_TYPE_COUNT     = 71,
    };
...
#    endif
    ...
    // Patch type_size at runtime (only for GGML_TYPE_TQK_FLEX)
    GGML_API void ggml_type_set_size(enum ggml_type type, size_t size);
